...
<ol type="decimal">
	<li>Half-hourly energy consumption by tariff rates </li>
...
<li> Average energy consumption by different tariff plans </li>
...
<li> Temperature vs mean energy consumption per ACORN group</li>
